...
SRC_URI += " \
    ...
    file://0005-configs-am625_sysworxx_a53-Bump-CONFIG_SPL_SYS_MALLO.patch \
    ...
    file://0008-board-ti-am62x-sysworxx.c-Detect-RAM-size-at-runtime.patch \
    file://0009-board-ti-am62x-sysworxx.env-Implement-EEPROM-board-d.patch \
    file://0010-board-ti-am62x-sysworxx.c-Detect-mmcdev-based-on-boo.patch \
    file://0011-board-ti-am62x-sysworxx.env-Introduce-custom-bootcom.patch \
    file://0012-board-ti-am62x-sysworxx.env-Load-restricted-environm.patch \
    file://0013-board-ti-am62x-sysworxx.env-Add-quiet-parameter-to-K.patch \
    file://0014-ti-am62x-Enable-first-internal-watchdog-and-pass-30s.patch \
    ${@bb.utils.contains('DISTRO_FEATURES', 'rauc', \
        'file://0015-board-ti-am62x-sysworxx.env-Implement-bootcmd-for-ra.patch', '', d)} \
"
